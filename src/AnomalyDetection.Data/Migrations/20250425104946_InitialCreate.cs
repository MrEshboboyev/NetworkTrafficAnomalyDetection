...
namespace AnomalyDetection.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AlertRelatedLogs",
                columns: table => new
                {
                    AnomalyAlertId = table.Column<int>(type: "integer", nullable: false),
                    RelatedLogsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlertRelatedLogs", x => new { x.AnomalyAlertId, x.RelatedLogsId });
                    table.ForeignKey(
                        name: "FK_AlertRelatedLogs_AnomalyAlerts_AnomalyAlertId",
                        column: x => x.AnomalyAlertId,
                        principalTable: "AnomalyAlerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlertRelatedLogs_NetworkTrafficLogs_RelatedLogsId",
                        column: x => x.RelatedLogsId,
                        principalTable: "NetworkTrafficLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AlertRelatedLogs_RelatedLogsId",
                table: "AlertRelatedLogs",
                column: "RelatedLogsId");
